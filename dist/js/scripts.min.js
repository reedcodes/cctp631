...
$(document).ready(()=>{// Find the ID for the video.
const a=$(".video").attr("data-id"),b=$("button.play"),c=$(document.createElement("iframe"));c.attr("src","https://www.youtube.com/embed/"+a+"?autoplay=1").attr("allow","autoplay"),b.on("click",()=>{b.remove(),$(".video").append(c)})});