...
$(document).ready(()=>{// Grab the video embed container.
const a=$(".video-embed"),b=a.attr("data-id"),c=$("button.play"),d=$(document.createElement("iframe"));// Find the ID for the video.
d.attr("src","https://www.youtube.com/embed/"+b+"?autoplay=1").attr("allow","autoplay").addClass("video"),c.on("click",()=>{c.remove(),a.append(d)})});